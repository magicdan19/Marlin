...
#define Z_MIN_ENDSTOP_INVERTING false  ///DAN avant true ??? Set to true to invert the logic of the endstop.
#define X_MAX_ENDSTOP_INVERTING false // Set to true to invert the logic of the endstop.
#define Y_MAX_ENDSTOP_INVERTING false // Set to true to invert the logic of the endstop.
#define Z_MAX_ENDSTOP_INVERTING false // Set to true to invert the logic of the endstop.
#define Z_MIN_PROBE_ENDSTOP_INVERTING false ///dan avant true Set to true to invert the logic of the probe.
...
#endif
#define MARLIN_EEPROM_SIZE 0x7fff ///dan selon mon eeprom
