...
#define Z_STEPPER_AUTO_ALIGN
   ...
   */
    //#define Z_STEPPER_ALIGN_XY { {  38.42, 205 }, { 400,  205 }}
...
/*#define DISABLE_INACTIVE_EXTRUDER true   ///dan nécessaire???? */
...
//#define BACKLASH_COMPENSATION
  ...
  //#define BACKLASH_GCODE
    ...
    #define MEASURE_BACKLASH_WHEN_PROBING
      ...
      #define BACKLASH_MEASUREMENT_FEEDRATE    Z_PROBE_FEEDRATE_SLOW // (mm/m)
    #endif
  #endif
#endif
...
#define ARC_SUPPORT                   // Requires ~3226 bytes
  ...
  #define MIN_CIRCLE_SEGMENTS    24   ///dan origine = 72; Minimum number of segments in a complete circle
